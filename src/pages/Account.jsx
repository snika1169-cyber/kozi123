...
function SignUpForm() {
  ...
  return (
    <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
      ...
      <button
        type="submit"
        className="w-full bg-cozy-terracotta text-white font-semibold py-3 rounded-xl hover:bg-cozy-terracotta-dark focus:outline-none focus:ring-2 focus:ring-cozy-terracotta focus:ring-offset-2 transition-colors shadow-sm"
      >
        Create account
      </button>
    </form>
